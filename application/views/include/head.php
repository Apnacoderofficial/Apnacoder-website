...
<html class="no-js" lang="en">
   <head>
      ...
      <!-- Site Title -->
      <title>Apnacoder - Digital Agency</title>
      ...
      <div class="tj-offcanvas-area d-lg-none">
         <div class="tj-offcanvas-header d-flex align-items-center justify-content-between">
            <div class="logo-area text-center">
               <a href="<?=base_url()?>index"><img src="assets/images/logo/dark-logo.png" alt="Logo" /></a>
            </div>
                     ...
                     <div class="topbar-content-area">
                        <div class="topbar-left-content">
                           <div class="topbar-contact">
                              <ul class="dot-style">
                                 <li><i class="flaticon-phone-with-wire"></i><a href="tel:+917007564392">+91 7007564392</a></li>
                                 <li><i class="flaticon-open-envelope"></i><a href="mailto:info@apnacoder.com">info@apnacoder.com</a></li>
                              </ul>
                           </div>
                        </div>
                        <div class="topbar-right-content">
                           <div class="topbar-share">
                              <ul class="dot-style">
                                 ...
                                 <li>
                                    <a href="https://twitter.com/apnacoder"> <i class="fa-brands fa-twitter"></i></a>
                                 </li>
                                 <li>
                                    <a href="https://wa.me/+917007564392"> <i class="fa-brands fa-whatsapp"></i> </a>
                                 </li>
                        ...
                        <div class="tj-menu-area d-lg-block d-none" id="main-menu">
                           <nav id="mobile-menu">
                              <ul>
                                 ...
                                 <li>
                                    <a href="<?=base_url()?>about"  class="<?= ($title == "About Us") ? 'active' : '' ?>" >About Us</a>
                                 </li>
                                 <li class="has-dropdown">
                                 ...
                                 <li><a href="<?=base_url()?>Portfolio" class="<?= ($title == "Contact") ? 'active' : '' ?>">Portfolio</a></li>
                              </ul>
                           </nav>
                        </div>
                        <div class="header-button d-flex d-none d-lg-block">
                           <a href="<?=base_url()?>contact" class="btn tj-black-btn">Contact Us</a>
                        </div>
