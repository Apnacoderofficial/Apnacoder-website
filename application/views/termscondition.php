				...
				<div class="col-lg-12">
					<div class="breadcrumb-content-area">
						<div class="breadcrumb-heading">
							<h1 class="breadcrumb-title wow fadeInUp" data-wow-delay=".3s">Terms & Condition</h1>
						</div>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-xl-12 col-lg-12">
					<div class="about-content-one" data-sal="slide-left" data-sal-duration="1000" data-sal-delay="600">
						<div class="tj-sec-heading">
							<span class="sub-title"> Terms & Condition</span>
							<h2 class="sec-title">Making Your Business More Unique</h2>
							<div>

								<p>Welcome to Apna Coder!</p>

								<p>These terms and conditions outline the rules and regulations for the use of Apna
									Coder's Website, located at https://www.apnacoder.com.</p>

								<p>By accessing this website we assume you accept these terms and conditions. Do not
									continue to use Apna Coder if you do not agree to take all of the terms and
								...
								<p>We employ the use of cookies. By accessing Apna Coder, you agreed to use cookies in
									agreement with the Apna Coder's Privacy Policy.</p>
								...
								<p>Unless otherwise stated, Apna Coder and/or its licensors own the intellectual
									property rights for all material on Apna Coder. All intellectual property rights are
									reserved. You may access this from Apna Coder for your own personal use subjected to
									restrictions set in these terms and conditions.</p>

								<p>You must not:</p>
								<ul>
									<li>Republish material from Apna Coder</li>
									<li>Sell, rent or sub-license material from Apna Coder</li>
									<li>Reproduce, duplicate or copy material from Apna Coder</li>
									<li>Redistribute content from Apna Coder</li>
								</ul>

								<p>This Agreement shall begin on the date hereof.</p>

								<p>Parts of this website offer an opportunity for users to post and exchange opinions
									and information in certain areas of the website. Apna Coder does not filter, edit,
									publish or review Comments prior to their presence on the website. Comments do not
									reflect the views and opinions of Apna Coder,its agents and/or affiliates. Comments
									reflect the views and opinions of the person who post their views and opinions. To
									the extent permitted by applicable laws, Apna Coder shall not be liable for the
								...
								<p>Apna Coder reserves the right to monitor all Comments and to remove any Comments
								...
								<p>You hereby grant Apna Coder a non-exclusive license to use, reproduce, edit and
								...
								<p>We will approve link requests from these organizations if we decide that: (a) the
									...
									benefit to us from the visibility of the hyperlink compensates the absence of Apna
									Coder; and (d) the link is in the context of general resource information.</p>
								...
								<p>If you are one of the organizations listed in paragraph 2 above and are interested in
									linking to our website, you must inform us by sending an e-mail to Apna Coder.
								...
								<p>No use of Apna Coder's logo or other artwork will be allowed for linking absent a
							...
							<div class="about-button d-flex">
								<a href="https://wa.me/+917007564392" class="tj-secondary-btn btn-border"><span>Connect
										Us</span></a>
							</div>
						</div>
					</div>
