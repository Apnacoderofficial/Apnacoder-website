                           ...
                           <div class="row video-box">
                              ...
                              <div class="col-lg-6">
                                 <div class="video-content">
                                    <h4 class="title">Roise Capital Faster & Segoticite On Your Own Trems</h4>
                                    <p>
                                       At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque
                                       corrupti quos dolores et quas.
                                    </p>
                                    <div class="check-list">
                                       <ul>
                                          <li><i class="fa-light fa-angle-right"></i> 100% Better Result</li>
                                          <li><i class="fa-light fa-angle-right"></i> Budget Friend Service</li>
                        ...
                        <div class="tj-comments-wrap">
                           <div class="tj-latest-comment">
                              ...
                              <div class="comment-content-area">
                                 <div class="comment-auother">
                                    <div class="comment-avatar">
                                       <img src="assets/images/testimonial/test-5.png" alt="Image" />
                                    </div>
                              ...
                              <div class="comment-content-area">
                                 <div class="comment-auother">
                                    <div class="comment-avatar">
                                       <img src="assets/images/testimonial/test-6.png" alt="Image" />
                                    </div>
                                    <div class="comment-text">
                                       <div class="auother-header">
                                          <h6 class="title-link">
                              ...
                              <div class="row">
                                 <div class="col-lg-6">
                                    <div class="form-input">
                                       <input type="text" id="first" name="name" placeholder="Fast Name" required="" />
                                    </div>
                                 </div>
                                 <div class="col-lg-6">
                                    <div class="form-input">
                                       <input type="text" id="last" name="name" placeholder="Last Name" required="" />
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-input">
                                 ...
                                 <div class="col-lg-12">
                                    <div class="form-input">
                                       <textarea id="comment" name="message" placeholder="Enter Your Comments"></textarea>
                                    </div>
                                 </div>
                                 <div class="tj-blog-details-button">
                                    <button class="tj-primary-btn" type="submit" value="submit">Submit Now</button>
                                 </div>
                              </div>
                           </div>
                        </div>
