				...
				<div class="col-lg-12">
					<div class="breadcrumb-content-area">
						<div class="breadcrumb-heading">
							<h1 class="breadcrumb-title wow fadeInUp" data-wow-delay=".3s">Privacy Policy</h1>
						</div>
...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to ApnaCoder, B/No.6/1 Link road , Near Kv2 OCF Shahjahanpur
            Cantt.</p>
    </li>
    <li>
    ...
    <li>
        <p><strong>Website</strong> refers to ApnaCoder, accessible from <a href="https://apnacoder.com/"
                rel="external nofollow noopener" target="_blank">https://apnacoder.com/</a></p>
    </li>
    <li>
...
<ul>
    <li>
        <p>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                data-cfemail="31424441415e43457150415f50525e5554431f525e5c">[email&#160;protected]</a></p>
    </li>
    <li>
        <p>By visiting this page on our website: <a href="https://apnacoder.com/contactus"
                rel="external nofollow noopener" target="_blank">https://apnacoder.com/contactus</a></p>
    </li>
    <li>
        <p>By phone number: 7237064392</p>
    </li>
</ul>
